...
//work on this thing 
//client must hold the path
/*
don't change the path from the server for multiple user access,
client must have the array or path based on cookie or smth,
pass the path to the changeDir.js, changeDir.js should reply with the current dir details
*/
const Users = props => (
    <li>
